...
# }
# modele_path <- "C:/Users/Public/Documents/modele_RDD.docx"
# options(officedown.reference_docx = "C:/Users/Public/Documents/modele_RDD.docx")
```
...
# if (nom_utilisateur == "ytran") {
#   # === CONFIGURATION POUR YTRAN ===
#   cat("Configuration spéciale pour ytran\n")
#   
#   modele_path <- "C:/Users/Public/Documents/modele_RDD.docx"
#   
#   if (!file.exists(modele_path)) {
#     stop("Modèle introuvable. Exécutez d'abord l'installation manuelle.")
#   }
#   
#   options(officedown.reference_docx = modele_path)
#   cat("✓ Modèle trouvé :", modele_path, "\n")
#   
# } else {
#   # === CONFIGURATION POUR LES AUTRES ===
#   cat("Configuration standard pour :", nom_utilisateur, "\n")
#   # Pas de modèle spécial, utilise le défaut officedown
#   modele_path <- "modele_RDD.docx"
#   
#   if (!file.exists(modele_path)) {
#     stop("Modèle introuvable. Exécutez d'abord l'installation manuelle.")
...
# Récupère le chemin vers le dossier contenant les signatures Outlook
# signature_dir <- file.path(Sys.getenv("APPDATA"), "Microsoft", "Signatures")
# 
# # Liste les fichiers .htm (ce sont ceux utilisés dans les mails HTML)
# signature_file <- list.files(signature_dir, pattern = "\\.htm$", full.names = TRUE)
# 
# signature_html <- readLines(signature_file[2], warn = FALSE, encoding = "UTF-8")
# signature_html <- paste(signature_html, collapse = "\n")
