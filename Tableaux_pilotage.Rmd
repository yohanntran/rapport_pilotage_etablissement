...
if(etablissement == "CHICAS"){
  ...
  taux_smr_rh2 = new_data_11[[2]]$`Différence (%)\n2025-2024`[3]
  ...
  if(length(new_data_9)>0){
    if(etablissement %in% c("CHEB","CHICAS","GHT")){
      ...
      if(etablissement %in% c("CHEB")){
        ...
        dat_list_9 = dat_list_9 %>% 
          mutate(`Différence (%)\n2025-2024` = (`2025`-`2024`)/`2024`*100) %>% data.frame
...
# pwet
if(etabb == "CHE"){
  objet <-  paste0(etabb, " - Rapport statistiques PMSI séjours MCO, SMR - M", mois_ajuste,"20",sum_graph_new_2025$Année[1])
  ...
  texte_corps <- paste0(
    ...
    objet <-  paste0(etabb, " - Rapport statistiques PMSI séjours MCO, PSY & HDJ - M", mois_ajuste,"20",sum_graph_new_2025$Année[1])
    ...
    objet <-  paste0(etabb, " - Rapport statistiques PMSI séjours MCO, HAD, SMR & HDJ - M", mois_ajuste,"20",sum_graph_new_2025$Année[1])
