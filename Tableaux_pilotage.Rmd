...
if(etabb == "CHE"){
  ...
  texte_corps <- paste0(
    ...
    objet <-  paste0(etabb, " - Rapport statistiques PMSI séjours MCO et PSY - M", mois_ajuste,"20",sum_graph_new_2025$Année[1])
    ...
    objet <-  paste0(etabb, " - Rapport statistiques PMSI séjours MCO, HAD & SMR - M", mois_ajuste,"20",sum_graph_new_2025$Année[1])
